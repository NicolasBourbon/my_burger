<?php
    ...
    if(!empty($_GET['id'])){ 
        ...
        echo("le dollarGet n est pas vide, on initialise donc l id"); 
        echo ' ';
    ...
    if(!empty($_POST)){ 
        ...
        echo ("si dollarPOst n est pas vide on initialise les variables");
        ...
        if(empty($image)){ 
            ...
            if($imageExtension != "jpg" && $imageExtension != "png" && $imageExtension != "jpeg" && $imageExtension != "gif" ){ 
                ...
                $imageError = "Les fichiers autorisées sont : .jpg, .jpeg, .png, .gif";
        ...
        if(($isSuccess && $isImageUpdated && $isUploadSuccess) || ($isSuccess && !$isImageUpdated)) { 
            ...
            $db = Database::connect();
            if ($isImageUpdated) { 
                echo(" succès et image updatée");
                $statement = $db->prepare("UPDATE items set name= ?, description = ?, price = ?, category = ?, image = ?  WHERE id = ?");
                $statement->execute(array($name, $description, $price, $category, $image, $id));
            } 
            else { 
                echo("succès et image non updatée");
